...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__history__ = __webpack_require__(907);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(77);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__order_by_pipe__ = __webpack_require__(908);
...
HistoryPageModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["a" /* NgModule */])({
        declarations: [__WEBPACK_IMPORTED_MODULE_1__history__["a" /* HistoryPage */], __WEBPACK_IMPORTED_MODULE_3__order_by_pipe__["a" /* OrderByPipe */]],
        imports: [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["e" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_1__history__["a" /* HistoryPage */])],
    })
], HistoryPageModule);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_onesignal__ = __webpack_require__(181);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_moment__ = __webpack_require__(778);
...
var HistoryPage = (function () {
    function HistoryPage(navCtrl, storage, af, alertCtrl, navParams, toast, oneSignal) {
        var _this = this;
        ...
        this.storage.get('uid').then(function (response) {
            ...
            _this.user = _this.af.list('/userProfile/' + response + "/parkingDetails/");
            _this.user.subscribe(function (response) {
                // this.spotDetails = [];
                for (var i = 0; i < response.length; i++) {
                    _this.spotIds[i] = response[i].$value;
                    __WEBPACK_IMPORTED_MODULE_4_firebase___default.a.database().ref('/spots/' + _this.spotIds[i])
                        .once("value", function (snapshot) {
                        if (snapshot.val()) {
                            var hold = snapshot.val();
                            console.log(1, hold);
                            hold.starttime = __WEBPACK_IMPORTED_MODULE_6_moment__(hold.starttime, "hh:mm A");
                            hold.starttime = __WEBPACK_IMPORTED_MODULE_6_moment__(hold.starttime).format('LT');
                            hold.endtime = __WEBPACK_IMPORTED_MODULE_6_moment__(hold.endtime, "hh:mm A");
                            hold.endtime = __WEBPACK_IMPORTED_MODULE_6_moment__(hold.endtime).format('LT');
                            console.log(2, hold);
                            _this.spotDetails.push(hold);
                            _this.showNoRequesters = true;
                        }
                    });
                }
            });
        ...
        this.storage.get('uid').then(function (uid) {
            ...
            //spot.publisherDetails.uid = response;
            //let key = this.spots.push(spot).key;
            _this.user = _this.af.list('/userProfile/' + uid + "/requestedSpotDetails/", {});
            _this.user.subscribe(function (userParkingDetails) {
                console.log('555555555555');
                var actualIndex = 0;
                var _loop_1 = function (i) {
                    _this.spotIds[i] = userParkingDetails[i].$value;
                    var userData = __WEBPACK_IMPORTED_MODULE_4_firebase___default.a.database().ref('/spots/' + _this.spotIds[i] + '/requesterDetails/');
                        ...
                        if (snapshot.val() != null) {
                            Object.keys(snapshot.val()).forEach(function (key) {
                                ...
                                Object.keys(value).forEach(function (key) {
                                    ...
                                    var getData = __WEBPACK_IMPORTED_MODULE_4_firebase___default.a.database().ref('/spots/' + _this.spotIds[i] + '/requesterDetails/' + primaryKey);
                                    getData.child(secondaryKey).once("value", function (snapshot) {
                                        console.log('each', snapshot.val());
                                        var data = snapshot.val();
                                        if (_this.uid == data.uid) {
                                            actualIndex++;
    ...
    HistoryPage.prototype.historyDetail = function (publisherDetails, date, requester) {
    ...
    HistoryPage.prototype.toggleHistory = function () {
        this.toggleDetails = !this.toggleDetails;
    };
    HistoryPage.prototype.deleteSpot = function (spot, i, slidingItem) {
        var _this = this;
        var alert = this.alertCtrl.create({
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.af.object('/spots/' + spot.$key).remove().then(function (response) {
                            slidingItem.close();
                            _this.spotDetails.splice(i, i + 1);
    ...
    HistoryPage.prototype.ClaimPoints = function (requester) {
        var _this = this;
            ...
            buttons: [
                {
                    ...
                    handler: function (data) {
                        ...
                        if (data.comment != '') {
                            var spotData = __WEBPACK_IMPORTED_MODULE_4_firebase___default.a.database().ref('/spots/' + _this.spotIds[requester.indexHold - 1] + '/requesterDetails/');
                            spotData.child(_this.uid).once("value", function (snapshot) {
                                var key = Object.keys(snapshot.val());
                                console.log('Requester user', key);
                                console.log('Requester user2', key[0]);
                                var spotUpdateData = __WEBPACK_IMPORTED_MODULE_4_firebase___default.a.database().ref('/spots/' + _this.spotIds[requester.indexHold - 1] + '/requesterDetails/' + _this.uid);
                ...
                },
                {
                    ...
                    handler: function (data) {
                        ...
                        var userData = __WEBPACK_IMPORTED_MODULE_4_firebase___default.a.database().ref('/userProfile/');
                        userData.child(_this.uid).once("value", function (snapshot) {
                            console.log('Current user', snapshot.val());
                            var currentUser = snapshot.val();
                            var creditPoint = currentUser.points + 10;
                            userData.child(_this.uid).update({ points: creditPoint });
                            var payUserData = __WEBPACK_IMPORTED_MODULE_4_firebase___default.a.database().ref('/userProfile/');
                            userData.child(requester.payPointsUid).once("value", function (snapshotData) {
                                console.log('Payee user', snapshotData.val());
                                var payeeUser = snapshotData.val();
                                var creditPoint = payeeUser.points + 20;
...
var OrderByPipe = (function () {
    ...
    OrderByPipe.prototype.transform = function (values) {
