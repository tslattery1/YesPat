...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PostFindspotPageModule", function() { return PostFindspotPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__post_findspot__ = __webpack_require__(914);
...
var PostFindspotPageModule = (function () {
    function PostFindspotPageModule() {
    }
    return PostFindspotPageModule;
}());
PostFindspotPageModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["a" /* NgModule */])({
        declarations: [__WEBPACK_IMPORTED_MODULE_1__post_findspot__["a" /* PostFindspotPage */]],
        imports: [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["e" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_1__post_findspot__["a" /* PostFindspotPage */])],
    })
], PostFindspotPageModule);

//# sourceMappingURL=post-findspot.module.js.map
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(897)(module)))
...
;(function (global, factory) {
    true ? factory(__webpack_require__(778)) :
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PostFindspotPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_geolocation__ = __webpack_require__(359);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_firebase__ = __webpack_require__(109);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_firebase___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_firebase__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_badge__ = __webpack_require__(367);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_moment__ = __webpack_require__(778);
...
var PostFindspotPage = (function () {
    function PostFindspotPage(navCtrl, http, storage, 
        // private nativeGeocoder: NativeGeocoder,
        // private localNotifications: LocalNotifications,
        alertCtrl, af, platform, geolocation, badge, event, loadingCtrl
        ...
        this.postForm = new __WEBPACK_IMPORTED_MODULE_8__angular_forms__["e" /* FormGroup */]({
            carInfo: new __WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* FormControl */]('', [__WEBPACK_IMPORTED_MODULE_8__angular_forms__["g" /* Validators */].required, this.NoWhitespaceValidator]),
            parkLocation: new __WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* FormControl */]('', [__WEBPACK_IMPORTED_MODULE_8__angular_forms__["g" /* Validators */].required, this.NoWhitespaceValidator]),
            starttime: new __WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* FormControl */]('', __WEBPACK_IMPORTED_MODULE_8__angular_forms__["g" /* Validators */].required),
            endtime: new __WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* FormControl */]('', __WEBPACK_IMPORTED_MODULE_8__angular_forms__["g" /* Validators */].required)
        }, customValidator);
        function customValidator(g) {
            return (parseFloat(g.get('endtime').value) - parseFloat(g.get('starttime').value)) >= 1 ? null : { isEqual: true };
        }
        this.findForm = new __WEBPACK_IMPORTED_MODULE_8__angular_forms__["e" /* FormGroup */]({
            currentLocation: new __WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* FormControl */]('', [__WEBPACK_IMPORTED_MODULE_8__angular_forms__["g" /* Validators */].required, this.NoWhitespaceValidator]),
            parkLocation: new __WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* FormControl */]('', [__WEBPACK_IMPORTED_MODULE_8__angular_forms__["g" /* Validators */].required, this.NoWhitespaceValidator]),
            desiredtime: new __WEBPACK_IMPORTED_MODULE_8__angular_forms__["f" /* FormControl */]('', __WEBPACK_IMPORTED_MODULE_8__angular_forms__["g" /* Validators */].required),
        });
    ...
    PostFindspotPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        this.storage.get('uid').then(function (uid) {
            _this.uid = uid;
            //spot.publisherDetails.uid = response;
            //let key = this.spots.push(spot).key;
            _this.af.list('/userProfile/' + uid + "/parkingDetails/")
                .subscribe(function (userParkingDetails) {
                _this.notifCount = 0;
                            ...
                            for (var j = 0; j < requesterDetails.length; j++) {
                                ...
                                while (Object.keys(requesterDetails[j])[k] != undefined) {
                                    ...
                                    if (requesterDetails[j][firstKey].status == 'Pending') {
                                        _this.requestingUserData.push(requesterDetails[j][firstKey]);
                                        notify++;
    ...
    PostFindspotPage.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.storage.get('uid').then(function (uid) {
            ...
            userData.child(uid).once("value", function (snapshot) {
                if (snapshot.val().subscription == false) {
                    _this.navCtrl.setRoot('SubscriptionPage', { subscriptionType: 'user', uid: uid });
                }
                else {
    ...
    PostFindspotPage.prototype.prepareRequest = function (url, body, method) {
        var _this = this;
        var options = {
            url: url,
            method: method,
    ...
    PostFindspotPage.prototype.handleError = function (err) {
    ...
    PostFindspotPage.prototype.prepareData = function (res) {
        return res;
    };
    PostFindspotPage.prototype.prepareHeaders = function () {
        var headers = new __WEBPACK_IMPORTED_MODULE_2__angular_http__["c" /* Headers */]();
        headers.append('Content-Type', 'application/x-www-form-urlencoded');
        return headers;
    };
    PostFindspotPage.prototype.notifyPromisr = function (notify, i) {
        var _this = this;
        console.log('Promise', notify, i);
        return new Promise(function (resolve, reject) {
            _this.notifCount = _this.notifCount + notify;
            _this.badge.set(_this.notifCount);
            console.log('Promise notify count', _this.notifCount);
            resolve();
        });
    };
    PostFindspotPage.prototype.getMapDetails = function (latLng) {
        var _this = this;
        return new Promise(function (resolve, reject) {
    ...
    PostFindspotPage.prototype.NoWhitespaceValidator = function (control) {
    ...
    //   }
    // }
    PostFindspotPage.prototype.updateSearch = function () {
        this.dontShowPredictions = false;
    ...
    PostFindspotPage.prototype.updateCurrentSearch = function () {
        this.dontShowCurrentPredictions = false;
        // console.log('modal > updateSearch');
    ...
    PostFindspotPage.prototype.chooseItem = function (item) {
        this.autocomplete.query = item.description;
        this.dontShowPredictions = true;
    };
    PostFindspotPage.prototype.chooseCurrentItem = function (item) {
    ...
    //   this.dontShowPredictions = true;
    // }
    PostFindspotPage.prototype.dismiss = function () {
        this.autocomplete.query = '';
        this.dontShowPredictions = true;
    };
    PostFindspotPage.prototype.currentdismiss = function () {
        this.currentAutocomplete.query = '';
        this.dontShowCurrentPredictions = true;
    };
    PostFindspotPage.prototype.postFormSubmit = function (form) {
        var _this = this;
        ...
        var address = this.postForm.get('parkLocation').value;
        geocoder.geocode({ 'address': address }, function (results, status) {
            if (status == google.maps.GeocoderStatus.OK) {
                var location_1 = { latitude: results[0].geometry.location.lat(), longitude: results[0].geometry.location.lng() };
                ...
                if (_this.userProfile.address) {
                    spot.publisherDetails.address = _this.userProfile.address;
                }
                if (_this.userProfile.phoneNumber) {
                    spot.publisherDetails.phoneNumber = _this.userProfile.phoneNumber;
                }
                spot.publisherDetails.email = _this.userProfile.email;
                spot.publisherDetails.name = _this.userProfile.name;
                spot.publisherDetails.playerId = _this.userProfile.playerId;
                _this.storage.get('uid').then(function (uid) {
                    var userData = __WEBPACK_IMPORTED_MODULE_6_firebase___default.a.database().ref('/userProfile/');
                    userData.child(uid + "/parkingDetails/").once("value", function (snapshot) {
                        if (snapshot.val()) {
                            var currentTime = new Date();
                            console.log('currentTime=>>>>>>>>>>>', currentTime);
                            var startdatetime = new Date(snapshot.val().lastParkingTime);
                            console.log('startdatetime =>>>>>>>>>>>', startdatetime);
                            // var enddatetime = currentTime.toString();
                            // Parse input
                            var mStart = __WEBPACK_IMPORTED_MODULE_10_moment__["utc"](startdatetime);
                            console.log('mStart=>>>>>>>>>>>', mStart);
                            var mEnd = __WEBPACK_IMPORTED_MODULE_10_moment__["utc"](currentTime);
                            console.log('mEnd=>>>>>>>>>>>', mEnd);
                            // Calculate difference and create duration
                            var dur = __WEBPACK_IMPORTED_MODULE_10_moment__["duration"](mEnd.diff(mStart));
                            ...
                            if (dur.hours() == 0) {
                                ...
                                _this.addParking(spot, uid, location_1);
                            }
                        }
                        else {
                            _this.addParking(spot, uid, location_1);
    ...
    PostFindspotPage.prototype.addParking = function (spot, uid, location) {
        var _this = this;
        console.log(1, spot, uid);
        spot.publisherDetails.uid = uid;
        var key = this.spots.push(spot).key;
        var lastParkingTime = new Date();
        console.log(5);
        ...
        var firebaseRef = __WEBPACK_IMPORTED_MODULE_6_firebase___default.a.database().ref('/geofire/');
        var geoFire = new GeoFire(firebaseRef);
        geoFire.set((_a = {},
            _a[key] = [location.latitude, location.longitude],
            _a)).then(function () {
            console.log(11);
            if (_this.loading) {
                _this.loading.dismiss();
            ...
            alert.present();
            console.log(22);
            _this.navCtrl.setRoot('HistoryPage');
        }, function (error) {
            if (_this.loading) {
                _this.loading.dismiss();
            }
    ...
    PostFindspotPage.prototype.findFormSubmit = function (form) {
        var _this = this;
        ...
        var geocoder = new google.maps.Geocoder();
        var address = this.findForm.get('parkLocation').value;
        geocoder.geocode({ 'address': address }, function (results, status) {
            if (status == google.maps.GeocoderStatus.OK) {
                var location_2 = { latitude: results[0].geometry.location.lat(), longitude: results[0].geometry.location.lng() };
                console.log('Location', location_2);
                var geoQuery = geoFire.query({
                    center: [location_2.latitude, location_2.longitude],
                    radius: 10
                });
                geoQuery.on("key_entered", function (key, location, distance) {
                    // console.log("Bicycle shop " + key + " found at " + location + " (" + distance + " km away)");
                    console.log('---->>>', key, location, distance);
                    _this.nearBySpotsKeys.push(key);
                });
                console.log('this.nearBySpotsKeys', _this.nearBySpotsKeys);
                //console.log("geoQuery" + JSON.stringify(geoQuery));
                geoQuery.on("ready", function () {
                    console.log("GeoQuery has loaded and fired all other events for initial data");
                    var currentAddress = _this.findForm.get('currentLocation').value;
                    geocoder.geocode({ 'address': currentAddress }, function (results, status) {
                        if (status == google.maps.GeocoderStatus.OK) {
                            var currentLocation = { latitude: results[0].geometry.location.lat(), longitude: results[0].geometry.location.lng() };
                            var desiredtime = _this.findForm.get('desiredtime').value;
                            geoQuery.cancel();
                            _this.navCtrl.push('ParkingListPage', {
                                "latitude": currentLocation.latitude,
                                "longitude": currentLocation.longitude,
                                "currentLocation": currentAddress,
                                "spots": _this.nearBySpotsKeys,
    ...
    PostFindspotPage.prototype.gotoNotificationPage = function () {
...
//# sourceMappingURL=post-findspot.js.map
